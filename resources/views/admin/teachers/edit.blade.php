...
<div class="d-flex align-items-center gap-3 mb-4">
    ...
    <div>
        <h2 class="fw-bold mb-0" style="font-size:1.4rem;color:#1e3a5f"><i class="bi bi-person-gear me-2"></i>Edit Teacher</h2>
        <p class="text-muted small mb-0">Updating: <strong>{{ $teacher->name }}</strong></p>
    </div>
</div>

@php $detail = $teacher->teacherDetail; @endphp

<form method="POST" action="{{ route('admin.teachers.update', $teacher->id) }}" enctype="multipart/form-data" novalidate>
@csrf @method('PUT')
...
<div class="row g-4">
    ...
    <div class="col-lg-8">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="user_name" value="{{ old('user_name', $teacher->user_name) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="password" name="password"
                               class="form-control @error('password') is-invalid @enderror" placeholder="Enter to change" />
                ...
                <div class="row g-3">
                    <div class="col-md-12">
                        ...
                        <textarea name="education" rows="3"
                                  class="form-control @error('education') is-invalid @enderror">{{ old('education', $detail->education ?? '') }}</textarea>
                        @error('education')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-md-12">
                        <label class="form-label fw-semibold">Job History</label>
                        <textarea name="job_history" rows="4"
                                  class="form-control @error('job_history') is-invalid @enderror">{{ old('job_history', $detail->job_history ?? '') }}</textarea>
        ...
        <div class="card qams-card">
            <div class="card-body p-4">
                <p class="section-title"><i class="bi bi-book-fill me-2"></i>Assigned Subjects</p>
                @if($subjects->isEmpty())
                ...
                <div class="subject-check-grid">
                    ...
                    <label class="subject-check-label">
                        <input type="checkbox" name="subjects[]" value="{{ $subject->id }}"
                               {{ in_array($subject->id, old('subjects', $assignedIds)) ? 'checked' : '' }}
